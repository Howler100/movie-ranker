// configs/missionimpossible-movies-config.js
window.MovieRankerConfig = {
  theme: {
    // put your MI background image here:
    background: 'assets/backgrounds/mission-impossible-background.jpg',
    // import a matching font in your HTML head (see step 3) and reference it here:
    fontFamily: "'Russo One', sans-serif"
  },
  movies: [
    { title: 'Mission Impossible (1996)',                           poster: 'assets/posters/missionimpossible/movies/Mission Impossible (1996).jpg' },
    { title: 'Mission Impossible II (2000)',                        poster: 'assets/posters/missionimpossible/movies/Mission Impossible II (2000).jpg' },
    { title: 'Mission Impossible III (2006)',                       poster: 'assets/posters/missionimpossible/movies/Mission Impossible III (2006).jpg' },
